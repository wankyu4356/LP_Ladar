...
@register
class SemaScraper(BaseScraper):
    name = "과학기술인공제회"
    short_name = "SEMA"
    # Use the list page instead of the single view page
    base_url = "https://www.sema.or.kr/sema/bbs/B0000022/list.do?menuNo=200069"
